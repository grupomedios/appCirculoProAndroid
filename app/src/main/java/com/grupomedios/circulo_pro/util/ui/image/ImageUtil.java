package com.grupomedios.circulo_pro.util.ui.image;
...
public class ImageUtil {
    ...
    private static final DisplayImageOptions.Builder DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER = new DisplayImageOptions.Builder()
            ...
            .showImageOnFail(R.drawable.logo_small).cacheOnDisk(true)
    ...
    public static void displayImageSync(ImageView view, String path, ImageLoadingListener listener) {
        ImageLoader loader = ImageLoader.getInstance();
        try {
            Bitmap loadImageSync = loader.loadImageSync(path);
            if (loadImageSync != null) {
                view.setImageBitmap(loadImageSync);
            } else {
                view.setImageResource(R.drawable.logo_small);
            }
        } catch (OutOfMemoryError e) {
            view.setImageResource(R.drawable.logo_small);
            e.printStackTrace();
    ...
    public static void displayRoundImage(ImageView view, String path, int cornerRadius, ImageLoadingListener listener) {
        ImageLoader loader = ImageLoader.getInstance();
        try {
            loader.displayImage(path, view, DEFAULT_DISPLAY_IMAGE_OPTIONS_BUIDLER
                    .displayer(new RoundedBitmapDisplayer(cornerRadius)).build(), listener);
        } catch (OutOfMemoryError e) {
            e.printStackTrace();
            loader.clearMemoryCache();
        }
